...
const Placeholder = props => {
	return (
		<div className='data-card'>
			...
			<p className='loading' style={{ width: '60%', height: 30 }} />
			<p className='loading' style={{ width: '100%', height: 12, margin: '8px 0' }} />
			<p className='loading' style={{ width: '80%', height: 12, margin: '8px 0' }} />
			<p className='loading' style={{ width: '100%', height: 12, margin: '8px 0' }} />
		</div>
	);
};
		...
		<div className='App'>
			<div className='container'>
				...
				<div className='card-container'>
					<LetSuspense condition={movies.length > 0} placeholder={Placeholder} multiplier={3} initialDelay={200}>
